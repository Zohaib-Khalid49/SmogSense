...
function AlertDialogPortal({
  ...
  // Portal into the app shell (the centered "device" card) when present, so
  // the dialog + overlay stay within the app column on large screens instead
  // of floating over the whole viewport. Falls back to body (Radix default).
  const container =
